...
public class Football04 {
  public static void main(String[] args) {
    List<Society> table = Arrays.asList(
        new Society(1, "FC Barcelona", 15, 24, 700, 455, 12, 65, 98, 156, 258, 222),
    ...
    System.out.println("Several Societies have 22 points");
    table.stream().filter(society -> society.getPoints() == 22)
        .forEach(System.out::println);

    System.out.println();
    System.out.println("Societies with 4 points");
    table.stream().filter(society -> society.getPoints() == 4)
        .forEach(System.out::println);
